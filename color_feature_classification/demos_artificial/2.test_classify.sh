...
do
    echo $i
    echo $n
    rosrun color_feature_classification test_classify_from_file $i c s -sub 10 -dim 100 -comp pca_result_c/compress_axis
    n=`expr $n + 1`
done
#
...
do
    echo $i
    echo $n
    rosrun color_feature_classification test_classify_from_file $i d s -sub 10 -dim 100 -comp pca_result_d/compress_axis
    n=`expr $n + 1`
done
#
...
do
    echo $i
    echo $n
    rosrun color_feature_classification test_classify_from_file $i g s -sub 10
    n=`expr $n + 1`
done
#
...
do
    echo $i
    echo $n
    rosrun color_feature_classification test_classify_from_file $i r s -sub 10 -dim 100 -comp pca_result_r/compress_axis
    n=`expr $n + 1`
done
