...
rosrun color_feature_classification computeSubspace_with_rotate d $files -rotate 1 pca_result_d/compress_axis
rosrun color_feature_classification computeSubspace g $files pca_result_g/compress_axis
rosrun color_feature_classification computeSubspace r $files pca_result_r/compress_axis
