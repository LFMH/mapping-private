...
do
	...
	rosrun color_feature_classification normalizeHist normalized_histograms/noiseless_${shape}_${color}.pcd $DATA/bin_normalization/minmax_r.txt normalized_histograms/noiseless_${shape}_${color}.pcd
    done
done
