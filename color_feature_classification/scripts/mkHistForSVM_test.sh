...
do
	...
	bash `rospack find color_feature_classification`/scripts/demos_artificial/2.computeFeature.sh

	mkdir hist_data_forSVM/test_features_${nlevel}${x}
	mv test_features_c hist_data_forSVM/test_features_${nlevel}${x}
	mv test_features_d hist_data_forSVM/test_features_${nlevel}${x}
	mv test_features_g hist_data_forSVM/test_features_${nlevel}${x}
	mv test_features_r hist_data_forSVM/test_features_${nlevel}${x}
