...
echo ""; echo "---------- VOSCH ---------"
bash train_svm.sh $2/train_features_r 137 $1_vosch 128 0.0078125
...
do
  echo ""; echo "========== TEST $dir =========="
#  echo ""; echo "---------- GRSD $dir ----------"
#  bash test_svm_novel.sh $dir/test_features_g 20 $1_grsd $n
#  echo ""; echo "---------- CHLAC $dir ----------"
#  bash test_svm_novel.sh $dir/test_features_c 981 $1_chlac $n
  echo ""; echo "---------- CONCAT $dir ----------"
  bash test_svm_novel.sh $dir/test_features_d 1001 $1_concat $n
  echo ""; echo "---------- VOSCH $dir ----------"
  bash test_svm_novel.sh $dir/test_features_r 137 $1_vosch $n
  ((n++))
done
