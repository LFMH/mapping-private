...
# colorCHLAC
	rosrun color_feature_classification computeSubspace_with_rotate c $files -dim 500 -comp pca_result_colorCHLAC/compress_axis -rotate 1 pca_result_colorCHLAC/$num
