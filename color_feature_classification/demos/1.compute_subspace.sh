...
# VFH
	...
	rosrun color_feature_classification computeSubspace $files -dim 8 -comp pca_result_vfh/compress_axis pca_result_vfh/$num
...
# colorCHLAC
	...
	rosrun color_feature_classification computeSubspace $files -dim 8 -comp pca_result_colorCHLAC/compress_axis pca_result_colorCHLAC/$num
