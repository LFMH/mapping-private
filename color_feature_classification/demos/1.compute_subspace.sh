...
do
    ...
    rosrun color_feature_classification computeSubspace_with_rotate c $files -dim 800 -comp pca_result_c/compress_axis -rotate 1 -subdiv 2 pca_result_c/$num
    rosrun color_feature_classification computeSubspace_with_rotate d $files -dim 800 -comp pca_result_d/compress_axis -rotate 1 -subdiv 2 pca_result_d/$num
    rosrun color_feature_classification computeSubspace g $files -subdiv 2 pca_result_g/$num
    rosrun color_feature_classification computeSubspace r $files -subdiv 2 pca_result_r/$num
