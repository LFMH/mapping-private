...
namespace realtime_perception
{
  ...
  template <typename PointT>
    class URDFCloudFilter : public pcl_ros::Filter
  {
    ...
    private:
      ...
      void initURDFModel (ros::NodeHandle private_nh);
      void loadURDFModel (TiXmlElement* root_element, urdf::Model &descr, ros::NodeHandle private_nh, bool visual = true, bool collision = true);
