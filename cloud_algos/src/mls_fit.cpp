...
void MovingLeastSquares::pre ()
{
  ...
  nh_.param("order", order_, order_);
  nh_.param("filter_points", filter_points_, filter_points_);
  nh_.param("polynomial_fit", polynomial_fit_, polynomial_fit_);
  nh_.param("compute_moments", compute_moments_, compute_moments_);
  nh_.param("sqr_gauss_param", sqr_gauss_param_, radius_*radius_);
